...
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyA8Z4taiiPw2G0zabhODq8KsFbYmoGE3pk")
GEMINI_MODEL = "gemini-2.5-flash"  # Modelo mais recente com suporte a visão (June 2025)
...
class GeminiVisionAnalyzer:
    ...
    def analyze_lesion(
        ...
        try:
            ...
            # Fazer requisição à API pública do Gemini
            headers = {
                "Content-Type": "application/json"
            }
            url = f"{self.api_url}?key={self.api_key}"  # API pública usa query param
